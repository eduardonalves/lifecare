...
<?php echo $this->Form->create('Produtoiten'); ?>
	<fieldset>
		<legend><?php echo __('Edit Produtoiten'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Produtoiten.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Produtoiten.id'))); ?></li>
