...
<?php echo $this->Form->create('Confignota'); ?>
	<fieldset>
		<legend><?php echo __('Edit Confignota'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Confignota.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Confignota.id'))); ?></li>
