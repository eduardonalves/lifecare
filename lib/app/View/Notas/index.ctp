...
<section> <!---section superior--->
	...
	<fieldset class="filtros">
		...
		<?php
			...
			echo $this->Form->input('nome',array('type'=>'select','label'=>'Pesquisa Rápida:','id'=>'quick-select', 'options' => $quicklinksList,'default' => $_GET['ql']));
		?>
		<a href="add-quicklink" class="bt-showmodal">
			...
			<?php
				...
				{
				//echo $this->Html->image('botao-excluir2.png',array('id'=>'quick-editar','action' => 'delete',  $_GET['ql']), null, __('Deseja excluir?' ));	
		...
		<div class="content-filtros">
			...
			<section id="filtro-protuto" class="coluna-esquerda">
				...
				<?php
					echo $this->Html->image('botao-tabela-configuracao.png', array('id' => 'bt-configuração', 'alt' => 'Configuração produtos', 'title' => 'Configuração produtos'));
				?>
				</a>
				...
				<?php	
					...
					echo $this->Search->input('codEAN', array('label' => 'Código EAN:','class'=>'tamanho-medio produtos-alinhamento'));
			...
			<section id="filtro-lote" class="coluna-central">
				<?php
					echo $this->Form->input('', array('label'=>array('id'=>'titulo-lote','text'=>'Dados do Lote'),'type'=>'checkbox', 'id' => 'checklote' , 'value' => 'lote'));
				?>
				
				<a href="add-config_lote" class="bt-showmodal">
				<?php
					echo $this->Html->image('botao-tabela-configuracao.png', array('id' => 'bt-configuracao', 'alt' => 'Configuração de lote', 'title' => 'Configuração de lote'));
				?>
				</a>
			...
			<section id="filtro-es" class="coluna-direita">
				<?php
					echo $this->Form->input('', array('label'=>array('id'=>'titulo-es','text'=>'Dados da Nota'),'type'=>'checkbox', 'id' => 'checkes' , 'value' => 'es'));
				?>
				
				<a href="add-config_entrasaida" class="bt-showmodal">
				<?php
					echo $this->Html->image('botao-tabela-configuracao.png', array('id' => 'bt-configuracao', 'alt' => 'Configuração da Nota', 'title' => 'Configuração da Nota'));
				?>
				</a>
