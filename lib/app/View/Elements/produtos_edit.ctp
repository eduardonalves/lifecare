		...
		<fieldset class="fieldset-esquerda">
			<div class="coluna-content">
				...
				<?php
					...
					echo $this->Form->input('Produto.codigo', array('type'=>'text','label'=>'Código:','value'=>h($produto['Produto']['codigo']),'class'=>'','disabled'=>'disabled'));
					...
					echo $this->Form->input('Produto.nome', array('required'=>'true','label'=>'Nome:','allowEmpty' => 'false','type'=>'text','value'=>h($produto['Produto']['nome']),'class'=>'tamanho-medio	','id'=>'', 'maxlength' => '100'));

					echo $this->Form->input('Produto.composicao', array('type'=>'text','label'=>'Composição:','value'=>h($produto['Produto']['composicao']),'class'=>'tamanho-medio','id'=>'', 'maxlength' => '100'));

					echo $this->Form->input('Produto.dosagem', array('type'=>'text','label'=>'Dosagem:','value'=>h($produto['Produto']['dosagem']),'class'=>'tamanho-pequeno','id'=>'', 'maxlength' => '100'));
					
					echo $this->Form->input('Produto.unidade', array('type' => 'select','options'=>$tiposUnidades));
			...
			<div class="coluna-content">
				...
				<?php		
					foreach($produto['Tributo'] as $tributo){
						...
						echo $this->Form->input('Tributo.ncm', array('type'=>'text','label'=>'NCM:','value'=>h($tributo['ncm']),'class'=>'tamanho-pequeno ncm', 'maxlength' => '6'));

						echo $this->Form->input('Tributo.cfop', array('type'=>'text','label'=>'CFOP:','value'=>h($tributo['cfop']),'class'=>'tamanho-pequeno cfop', 'maxlength' => '6'));
						...
						echo $this->Form->input('Tributo.codigo_selo_ipi', array('type'=>'text','label'=>'Cód Selo IPI:','value'=>h($tributo['codigo_selo_ipi']),'class'=>'tamanho-medio s-ipi','id'=>'', 'maxlength' => '10'));
	...
	<section id="coluna-direita" class="coluna-direita" >
		<fieldset>
			...
			<div class="estoque coluna-content">
				<?php
					echo $this->Form->input('Produto.estoque_minimo', array('label'=>'Estoque Mínimo:','type'=>'text','value'=>h($produto['Produto']['estoque_minimo']),'class'=>'tamanho-pequeno numberMask', 'id' => 'ProdutoEstoqueMinimo', 'maxlength' => '10'));

					echo $this->Form->input('Produto.estoque_desejado', array('type'=>'text','label'=>'Estoque Ideal:','value'=>h($produto['Produto']['estoque_desejado']),'class'=>'tamanho-pequeno numberMask','id'=>'estoqueIdeal', 'maxlength' => '10'));
