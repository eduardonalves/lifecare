		...
		<div class="content-filtros">
			...
			<section id="filtro-parcela" class="coluna-direita">
				...
				<?php
					...
					echo $this->Search->input('cpf_cnpj',array('type'=>'text','id'=>'cpf_cnpj','class' => 'tamanho-medio ','style'=>'background:#EBEAFC;','disabled'=>'disabled','label'=>'', 'div' => array('class' => 'input text divCpfCnpj')));
