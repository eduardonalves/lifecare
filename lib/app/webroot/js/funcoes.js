...
var princ_cont = 0;
	...
	*/		
			...
			$('fieldset').append('<div class="input number clonado'+princ_cont+'" style="position:absolute"><input name="data[Produto]['+princ_cont+'][codigo] step="any"  id="ProdutoCodigo'+princ_cont+'codigo" value="'+codigo+'" type="hidden"></div> ');
			$('fieldset').append('<div class="input number clonado'+princ_cont+'" style="position:absolute"><input name="data[Produto]['+princ_cont+'][[nome]] step="any"  id="ProdutoNome'+princ_cont+'nome" value="'+nome+'" type="hidden"></div> ');
			$('fieldset').append('<div class="input number clonado'+princ_cont+'" style="position:absolute"><input name="data[Produto]['+princ_cont+'][[qtde]] step="any"  id="ProdutoQtde'+princ_cont+'qtde" value="'+qtde+'" type="hidden"></div> ');
			$('fieldset').append('<div class="input number clonado'+princ_cont+'" style="position:absolute"><input name="data[Produto]['+princ_cont+'][unidade] step="any"  id="ProdutoUnidade'+princ_cont+'unidade" value="'+unidade+'" type="hidden"></div> ');
			$('fieldset').append('<div class="input number clonado'+princ_cont+'" style="position:absolute"><input name="data[Produto]['+princ_cont+'][descricao] step="any"  id="ProdutoDescricao'+princ_cont+'descricao" value="'+descricao+'" type="hidden"></div> ');
			$('fieldset').append('<div class="input number clonado'+princ_cont+'" style="position:absolute"><input name="data[Produto]['+princ_cont+'][valor_unitario] step="any"  id="ProdutoValorUnitario'+princ_cont+'valor_unitario" value="'+valor_unitario+'" type="hidden"></div> ');
			$('fieldset').append('<div class="input number clonado'+princ_cont+'" style="position:absolute"><input name="data[Nota]['+princ_cont+'][valor_total] step="any"  id="NotaValorTotal'+princ_cont+'valor_total" value="'+valor_total+'" type="hidden"></div> ');
			...
			$('fieldset').append('<div class="input number clonado'+princ_cont+'" style="position:absolute"><input name="data[Produtoiten]['+princ_cont+'][valor_icms] step="any"  id="ProdutoitenValorIcms'+princ_cont+'valor_icms" value="'+valor_icms+'" type="hidden"></div> ');
			$('fieldset').append('<div class="input number clonado'+princ_cont+'" style="position:absolute"><input name="data[Nota]['+princ_cont+'][valor_ipi] step="any"  id="NotaValorIpi'+princ_cont+'valor_ipi" value="'+valor_ipi+'" type="hidden"></div> ');
			$('fieldset').append('<div class="input number clonado'+princ_cont+'" style="position:absolute"><input name="data[Model][Lote]['+princ_cont+'][lote] step="any"  id="ModelLote'+princ_cont+'lote" value="'+lote+'" type="hidden"></div> ');
			...
			$('fieldset').append('<div class="input number clonado'+princ_cont+'" style="position:absolute"><input name="data[Nota]['+princ_cont+'][tipo] step="any"  id="NotaTipo'+princ_cont+'tipo" value="'+Nota_Tipo+'" type="hidden"></div> ');
			...
			valor_total_produtos=$('#NotaValorTotalProdutos').val()
