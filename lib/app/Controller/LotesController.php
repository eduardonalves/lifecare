 ...
 */
	public function add() {
		if ($this->request->is('post')) {
			...
			$dataValidade=$produtoId= $this->request->data['Lote']['data_validade'];
			$dataFabricacao= $this->request->data['Lote']['data_fabricacao'];
			
			$countLote= $this->Lote->find('count', array('conditions' => array('Lote.numero_lote'=> $numeroLote, 'Lote.produto_id' => 180 )));	
