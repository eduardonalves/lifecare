<?php
App::uses('SituacaotribcofinsController', 'Controller');

/**
 * SituacaotribcofinsController Test Case
 *
 */
class SituacaotribcofinsControllerTest extends ControllerTestCase {
