<?php
App::uses('MotivodesoneracaosController', 'Controller');

/**
 * MotivodesoneracaosController Test Case
 *
 */
class MotivodesoneracaosControllerTest extends ControllerTestCase {
