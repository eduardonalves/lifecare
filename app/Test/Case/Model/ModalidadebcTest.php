<?php
App::uses('Modalidadebc', 'Model');

/**
 * Modalidadebc Test Case
 *
 */
class ModalidadebcTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Modalidadebc = ClassRegistry::init('Modalidadebc');
	}
