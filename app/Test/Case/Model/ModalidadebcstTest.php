<?php
App::uses('Modalidadebcst', 'Model');

/**
 * Modalidadebcst Test Case
 *
 */
class ModalidadebcstTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Modalidadebcst = ClassRegistry::init('Modalidadebcst');
	}
