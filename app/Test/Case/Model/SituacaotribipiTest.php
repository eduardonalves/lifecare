<?php
App::uses('Situacaotribipi', 'Model');

/**
 * Situacaotribipi Test Case
 *
 */
class SituacaotribipiTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Situacaotribipi = ClassRegistry::init('Situacaotribipi');
	}
