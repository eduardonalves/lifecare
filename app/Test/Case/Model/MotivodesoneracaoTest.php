<?php
App::uses('Motivodesoneracao', 'Model');

/**
 * Motivodesoneracao Test Case
 *
 */
class MotivodesoneracaoTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Motivodesoneracao = ClassRegistry::init('Motivodesoneracao');
	}
