<?php
App::uses('Situacaotribpi', 'Model');

/**
 * Situacaotribpi Test Case
 *
 */
class SituacaotribpiTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Situacaotribpi = ClassRegistry::init('Situacaotribpi');
	}
