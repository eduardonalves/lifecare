...
Date: Tue, 21 Oct 2014 18:45:45 GMT
Connection: close

<definitions name='CadConsultaCadastro2' targetNamespace='http://www.portalfiscal.inf.br/nfe/wsdl/CadConsultaCadastro2' xmlns='http://schemas.xmlsoap.org/wsdl/' xmlns:soap12='http://schemas.xmlsoap.org/wsdl/soap12/' xmlns:tns='http://www.portalfiscal.inf.br/nfe/wsdl/CadConsultaCadastro2' xmlns:xsd='http://www.w3.org/2001/XMLSchema'>
 <types>
 ...
 <message name='CadConsultaCadastro2Service_cadConsultaCadastro2Response'>
  <part element='tns:cadConsultaCadastro2Result' name='cadConsultaCadastro2Result'></part>
 </message>
 <portType name='CadConsultaCadastro2Service'>
  <operation name='cadConsultaCadastro2' parameterOrder='nfeCabecMsg nfeDadosMsg'>
   <input message='tns:CadConsultaCadastro2Service_cadConsultaCadastro2'></input>
   <output message='tns:CadConsultaCadastro2Service_cadConsultaCadastro2Response'></output>
  </operation>
 </portType>
 <binding name='CadConsultaCadastro2ServiceBinding' type='tns:CadConsultaCadastro2Service'>
  ...
  <operation name='cadConsultaCadastro2'>
   ...
   <input>
    ...
    <soap12:header message='tns:CadConsultaCadastro2Service_cadConsultaCadastro2' part='nfeCabecMsg' use='literal'></soap12:header>
   </input>
   <output>
 ...
 <service name='CadConsultaCadastro2'>
  <port binding='tns:CadConsultaCadastro2ServiceBinding' name='CadConsultaCadastro2ServicePort'>
   <soap12:address location='https://homolog.sefaz.go.gov.br/nfe/services/v2/CadConsultaCadastro2'/>
  </port>
 </service>
</definitions>