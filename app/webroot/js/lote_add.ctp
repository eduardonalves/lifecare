	...
	<section class="coluna-modal">
		...
		<div id="lote-modal">
			...
			<?php
				...
				//echo $this->Form->input('Lote.numero_lote',array('class'=>'tamanho-medio validacao-entrada','required'=>'true','allowEmpty' => 'false','title'=>'Campo Obrigatório','label'=>'Número do Lote<span class="campo-obrigatorio">*</span>:'));
			?>


			
			<?php	
				echo '<span id="validaModLoteNumLote" style="display:none">Preencha o campo lote</span>';
