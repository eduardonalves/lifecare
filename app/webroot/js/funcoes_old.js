...
/*************** Tabela dinâmica dados lote ***********************/
	...
	$('body').on('click', '#btn-addLote',function() {
		...
		if(numeroLoteAdd !=undefined){
			...
			$('fieldset').append('<div class="input number clonado'+lote_cont+'" style="position:absolute"><input name="data[Loteiten]['+lote_cont+'][produto_id] step="any"  id="LoteinteProduto_id'+lote_cont+'produto_id" value="'+produtoid+'" type="hidden"></div> ');
