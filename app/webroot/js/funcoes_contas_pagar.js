...
/********** Adicionar na tabela Principal ****************/
	...
	obs = $('#ContaspagarParcelaDescricao').val();
...
/********* Função Editar da tabela ******************/
	...
	$('#ContaspagarParcelaDescricao').val(obsAnt);
