...
/**********************************************************/
	...
	$("#EntradaData").change(function(){
	    ...
	    var dfuturoEntrada = $("#EntradaData").val();
	    var dfuturoSaida = $("#SaidaData").val();
	    var dataAtual = new Date();
	    var dataFormat = ( (dataAtual.getDate()) + '/' + dataAtual.getMonth()+1) + '/' + dataAtual.getFullYear();

	    if(tipoOperacao == 0){
		if(dfuturoEntrada > dataFormat || dfuturoSaida > dataFormat){
		    //entrada
...
return get;
	...
	var urlPadrao = ""+location.host+"/notas/index/?";
	var limit = get.limit;
...
/*
		...
		var urlAction = ""+location.host+"/Lotes/add";
...
/*
		var urlAction = ""+location.host+"/produtos/add";
...
var princ_cont = 0;
	...
	*/
	...
	if(!ValidaCamposBtAdicionar()){
	    ...
	    $("#EntradaValorTotalProdutos").val(resultTotal.toFixed(2));
...
function calcValorNota(){
		...
		$('#EntradaValorTotal').val(novoTotalNota.toFixed(2));
...
function somarIcmsIpi(){
	...
	$("#EntradaValorIcms").val(vlIcmsNovo.toFixed(2));
	...
	$("#EntradaValorIpi").val(vlIpiNovo.toFixed(2));
...
/******************** Excluir tabela principal *******************/
	$("body").on("click",'.btnRemove', function(e){
		...
		$("#EntradaValorTotalProdutos").val(novoVal.toFixed(2));
		...
		$("#EntradaValorIpi").val(novoValIpi.toFixed(2));
		...
		$("#EntradaValorIcms").val(novoValIcms.toFixed(2));		
