...
<?php echo $this->Form->create('Comtokencotacao'); ?>
	<fieldset>
		<legend><?php echo __('Edit Comtokencotacao'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Comtokencotacao.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Comtokencotacao.id'))); ?></li>
