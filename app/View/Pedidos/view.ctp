	...
	<fieldset>
		...
		<section class="coluna-direita">
			...
			<?php
				...
				echo $this->Form->input('Comoperacao.data_entrega',array('label'=>'Previsão de Entrega:','type'=>'text','class'=>'tamanho-medio borderZero','value'=>$pedido['Pedido']['data_entrega'],'disabled'=>'disabled'));	
