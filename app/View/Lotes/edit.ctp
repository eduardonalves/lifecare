...
<?php echo $this->Form->create('Lote'); ?>
	<fieldset>
		<legend><?php echo __('Edit Lote'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Lote.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Lote.id'))); ?></li>
