...
<?php echo $this->Form->create('PosicaoestoquesProduto'); ?>
	<fieldset>
		<legend><?php echo __('Edit Posicaoestoques Produto'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PosicaoestoquesProduto.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('PosicaoestoquesProduto.id'))); ?></li>
