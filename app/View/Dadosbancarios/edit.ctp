...
<?php echo $this->Form->create('Dadosbancario'); ?>
	<fieldset>
		<legend><?php echo __('Edit Dadosbancario'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Dadosbancario.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Dadosbancario.id'))); ?></li>
