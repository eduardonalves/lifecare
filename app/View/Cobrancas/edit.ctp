...
<?php echo $this->Form->create('Cobranca'); ?>
	<fieldset>
		<legend><?php echo __('Edit Cobranca'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Cobranca.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Cobranca.id'))); ?></li>
