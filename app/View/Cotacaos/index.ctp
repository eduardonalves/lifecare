<div class="cotacaos index">
	<h2><?php echo __('Cotacaos'); ?></h2>
	...
	<?php foreach ($cotacaos as $comoperacao): ?>
	<tr>
		<td><?php echo h($comoperacao['Cotacao']['id']); ?>&nbsp;</td>
		<td><?php echo h($comoperacao['Cotacao']['data_inici']); ?>&nbsp;</td>
		<td><?php echo h($comoperacao['Cotacao']['data_fim']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($comoperacao['User']['id'], array('controller' => 'users', 'action' => 'view', $comoperacao['User']['id'])); ?>
		</td>
		<td><?php echo h($comoperacao['Cotacao']['valor']); ?>&nbsp;</td>
		<td><?php echo h($comoperacao['Cotacao']['prazo_entrega']); ?>&nbsp;</td>
		<td><?php echo h($comoperacao['Cotacao']['forma_pagamento']); ?>&nbsp;</td>
		<td><?php echo h($comoperacao['Cotacao']['status']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $comoperacao['Cotacao']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $comoperacao['Cotacao']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $comoperacao['Cotacao']['id']), null, __('Are you sure you want to delete # %s?', $comoperacao['Cotacao']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('New Cotacao'), array('action' => 'add')); ?></li>
