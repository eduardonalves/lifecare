<div class="cotacaos view">
<h2><?php echo __('Cotacao'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($comoperacao['Cotacao']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Data Inici'); ?></dt>
		<dd>
			<?php echo h($comoperacao['Cotacao']['data_inici']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Data Fim'); ?></dt>
		<dd>
			<?php echo h($comoperacao['Cotacao']['data_fim']); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo h($comoperacao['Cotacao']['valor']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Prazo Entrega'); ?></dt>
		<dd>
			<?php echo h($comoperacao['Cotacao']['prazo_entrega']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Forma Pagamento'); ?></dt>
		<dd>
			<?php echo h($comoperacao['Cotacao']['forma_pagamento']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Status'); ?></dt>
		<dd>
			<?php echo h($comoperacao['Cotacao']['status']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Cotacao'), array('action' => 'edit', $comoperacao['Cotacao']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Cotacao'), array('action' => 'delete', $comoperacao['Cotacao']['id']), null, __('Are you sure you want to delete # %s?', $comoperacao['Cotacao']['id'])); ?> </li>
