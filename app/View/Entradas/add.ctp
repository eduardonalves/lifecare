...
<header >
	<?php echo $this->Html->image('titulo-entrada.png', array('id' => 'titulo-entrada', 'alt' => 'Entrada', 'title' => 'Entrada')); ?>
...
<!--Fieldset Dados da nota-->	
	<fieldset class="primeira-field">
		...
		<section class="lateral-a-direita" id="campo-direita">
			...
			<?php echo $this->Form->input('Nota.valor_total', array('type'=>'text','class'=>'tamanho-medio','label'=>'Valor Total:','tabindex'=>'5')); ?>
