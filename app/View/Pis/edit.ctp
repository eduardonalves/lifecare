...
<?php echo $this->Form->create('Pi'); ?>
	<fieldset>
		<legend><?php echo __('Edit Pi'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Pi.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Pi.id'))); ?></li>
