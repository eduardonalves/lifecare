<div class="pedidovendas index">
	<h2><?php echo __('Pedidovendas'); ?></h2>
	...
	<?php foreach ($pedidovendas as $pedidovenda): ?>
	<tr>
		<td><?php echo h($pedidovenda['Pedidovenda']['id']); ?>&nbsp;</td>
		<td><?php echo h($pedidovenda['Pedidovenda']['data_inici']); ?>&nbsp;</td>
		<td><?php echo h($pedidovenda['Pedidovenda']['data_fim']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($pedidovenda['User']['id'], array('controller' => 'users', 'action' => 'view', $pedidovenda['User']['id'])); ?>
		</td>
		<td><?php echo h($pedidovenda['Pedidovenda']['valor']); ?>&nbsp;</td>
		<td><?php echo h($pedidovenda['Pedidovenda']['prazo_entrega']); ?>&nbsp;</td>
		<td><?php echo h($pedidovenda['Pedidovenda']['forma_pagamento']); ?>&nbsp;</td>
		<td><?php echo h($pedidovenda['Pedidovenda']['status']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $pedidovenda['Pedidovenda']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $pedidovenda['Pedidovenda']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $pedidovenda['Pedidovenda']['id']), null, __('Are you sure you want to delete # %s?', $pedidovenda['Pedidovenda']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
