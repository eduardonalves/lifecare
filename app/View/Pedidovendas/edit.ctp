<div class="pedidovendas form">
<?php echo $this->Form->create('Pedidovenda'); ?>
	<fieldset>
		<legend><?php echo __('Edit Pedidovenda'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Pedidovenda.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Pedidovenda.id'))); ?></li>
