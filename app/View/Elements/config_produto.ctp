		...
		<?php echo $this->Form->create('Configproduto'); ?>
				...
				<?php
					...
					if($configproduto['Configproduto']['estoque']==1){
						echo $this->Form->input('estoque', array('value' => 1, 'checked' =>'checked', 'label'=>'Estoque Atual' ));
					} else{
						echo $this->Form->input('estoque', array('label' => 'Estoque Atual'));
					}
					...
					if($configproduto['Configproduto']['nivel']==1){
						echo $this->Form->input('nivel', array('value' => 1, 'checked' =>'checked', 'label'=>'Nível Estoque'));
					} else{
						echo $this->Form->input('nivel', array('label' => 'Nível Estoque'));
					}
