	...
	<section class="coluna-modal">
		<div>
			...
			<?php
				...
				echo $this->Form->input('Centrocusto',array('label' => 'Nome Custo:','type'=>'text', 'class' => 'tamanho-medio'));
				echo $this->Form->input('Centrocusto',array('label' => 'Limite:','type'=>'text', 'class' => 'tamanho-pequeno dinheiro_duasCasas'));
				echo $this->Form->input('Centrocusto',array('label' => 'Limite Atual:','type'=>'text', 'class' => 'tamanho-pequeno dinheiro_duasCasas'));
			?>	
