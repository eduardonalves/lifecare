...
<!--Div primeiro Campo-->
	<div class="campo-superior-total tela-resultado">
		<div class="campo-superior-esquerdo">
			<?php
			    echo $this->Form->input('forma_de_entrada', array('id'=>'vale','options'=>array('Nota', 'Vale'), 'label' => 'Forma de Saída'));
			?>
		</div>

		<div class="campo-superior-direito">
			<?php
			    echo $this->Form->input('devolucao', array('label'=>'Saída de uma Devolução'));
			?>
		</div>
