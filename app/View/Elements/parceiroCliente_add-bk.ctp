...
<section> <!---section superior--->
	...
	<section class="coluna-esquerda">
		...
		<?php
			echo $this->Form->input('tipo',array('class' => 'obrigatorio','disabled' => 'true','label' => 'Classificação:','id' => 'ParceirodenegocioClassificacao','options'=>array('CLIENTE'=>'Cliente'),'type' => 'select','div' =>array( 'class' => 'input select')));
