										...
										<?php
											...
											foreach($configprod as $campo=>$campoLabel){							
												if($campo=="nivel"){
													...
													echo "<td class=\"$campo whiteSpace\" ><span title=\"". $categoria. "\">" . $categoria . "&nbsp;</span></td>";								
												}else if($campo == "nome"){	
													echo "<td class=\"$campo whiteSpace\" ><span title=\"". $produto['Produto'][$campo] . "\">" . $produto['Produto'][$campo] . "&nbsp;</span></td>";
												}else{	
