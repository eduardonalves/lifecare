	...
	<section> <!---section superior--->
		...
		<section class="coluna-esquerda">
			...
			<section class="coluna" >
				<div>
				<?php
				echo $this->Form->input('Produto.nome',array('required'=>'true','class'=>'tamanho-medi','id'=>'', 'label' => 'Nome<span class="campo-obrigatorio">*</span>:'));
			...
			<section class="coluna-direita" >
				...
				<?php
					...
					echo $this->Form->input('field.Unidade', array('label'=>'Unidade<span class="campo-obrigatorio">*</span>:','required'=>'true','options'=>array('adicionar',2,3,4,)));
					?>
					<br/>
					<div class="periodo">
				<?php
