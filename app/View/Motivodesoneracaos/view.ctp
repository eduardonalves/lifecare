<div class="motivodesoneracaos view">
<h2><?php echo __('Motivodesoneracao'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($motivodesoneracao['Motivodesoneracao']['id']); ?>
			&nbsp;
		</dd>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Motivodesoneracao'), array('action' => 'edit', $motivodesoneracao['Motivodesoneracao']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Motivodesoneracao'), array('action' => 'delete', $motivodesoneracao['Motivodesoneracao']['id']), null, __('Are you sure you want to delete # %s?', $motivodesoneracao['Motivodesoneracao']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($motivodesoneracao['Icm'])): ?>
	...
	<?php foreach ($motivodesoneracao['Icm'] as $icm): ?>
		<tr>
