<div class="modalidadebcsts view">
<h2><?php echo __('Modalidadebcst'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($modalidadebcst['Modalidadebcst']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Descricao'); ?></dt>
		<dd>
			<?php echo h($modalidadebcst['Modalidadebcst']['descricao']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Modalidadebcst'), array('action' => 'edit', $modalidadebcst['Modalidadebcst']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Modalidadebcst'), array('action' => 'delete', $modalidadebcst['Modalidadebcst']['id']), null, __('Are you sure you want to delete # %s?', $modalidadebcst['Modalidadebcst']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($modalidadebcst['Icm'])): ?>
	...
	<?php foreach ($modalidadebcst['Icm'] as $icm): ?>
		<tr>
