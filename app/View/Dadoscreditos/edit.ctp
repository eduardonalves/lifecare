...
<?php echo $this->Form->create('Dadoscredito'); ?>
	<fieldset>
		<legend><?php echo __('Edit Dadoscredito'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Dadoscredito.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Dadoscredito.id'))); ?></li>
