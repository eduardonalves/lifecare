<div class="situacaotribicms index">
	<h2><?php echo __('Situacaotribicms'); ?></h2>
	...
	<?php foreach ($situacaotribicms as $situacaotribicm): ?>
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $situacaotribicm['Situacaotribicm']['id']), null, __('Are you sure you want to delete # %s?', $situacaotribicm['Situacaotribicm']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
