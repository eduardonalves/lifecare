...
<?php echo $this->Form->create('Parcela'); ?>
	<fieldset>
		<legend><?php echo __('Edit Parcela'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Parcela.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Parcela.id'))); ?></li>
