...
<?php echo $this->Form->create('Negociacao'); ?>
	<fieldset>
		<legend><?php echo __('Edit Negociacao'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Negociacao.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Negociacao.id'))); ?></li>
