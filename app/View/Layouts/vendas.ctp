		...
		<section class="content-top">
			...
			<nav id="menu">
				<ul>
					...
					<li><a href='<?php echo $this->Html->url(array("controller"=>"Notas","action"=>"index"),true);?>/?parametro=vendas'><span>Vendas</span></a></li>
					<!--
	...
	<section class="content holder">			
		<nav id="nav-lateral">	
			<ul>
				...
				<li class="item">
					<a class="menuLink" href='<?php echo $this->Html->url(array("controller"=>"Notas","action"=>"add","layout"=>"vendas","abas"=>"42"),true);?>'>
						
						<?php echo $this->Html->image('cadastrar.png', array('id' => 'aside-cadastrar-icon', 'alt' => 'Cadastrar Pedido', 'title' => 'Cadastrar Pedido')); ?>
				...
				<li class="item">
					<a class="menuLink" href='<?php echo $this->Html->url(array("controller"=>"Notas","action"=>"add","layout"=>"vendas","abas"=>"44"),true);?>'>
						
						<?php echo $this->Html->image('cadastrar.png', array('id' => 'aside-cadastrar-icon', 'alt' => 'Cadastrar Pedido', 'title' => 'Cadastrar Pedido')); ?>

						<span class="label">Cadastrar Pedido</span>
					</a>
				</li>
