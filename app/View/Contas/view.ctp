...
<section class="clearBoth">
	...
	<?php
	    ...
	    echo "<a href='add-cobranca' class='bt-showmodal'>";
	    echo $this->html->image('botao-novo-limite.png',array('alt'=>'Adicionar Cobrança','title'=>'Adicionar Cobrança','id'=>'bt-corbanca','class'=>'bt-direita'));
	    echo "</a>";
	 ?>
</section>
