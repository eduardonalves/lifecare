...
<section> <!---section superior--->
	...
	<section class="coluna-esquerda">
		...
		<div style="float: left; position: relative; display: inline;">
			...
			<?php echo $this->Form->input('descricao',array('label' => 'Observação:','value'=>h($conta['Conta']['descricao']),'class' => 'tamanho-grande borderZero','disabled'=>'disabled')); ?>
									...
									<?php echo $this->Form->create('Parcela', array('type' => 'file','action'=>'uploadParcela')); ?>
										...
										<div class="input file">
											...
											<a id="teste" href="#">
												...
												<?php 
													echo $this->Form->html('id',array('type'=>'hidden','value'=>$parcelas['id']));
